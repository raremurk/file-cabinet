...
namespace FileCabinetApp.Helpers
{
    ...
    public static class RecordsComparer
    {
        ...
        public static bool RecordsEquals(FileCabinetRecord record, RecordToSearch search)
        {
            ...
            if (search.AndMode)
            {
                return record.FirstName.Equals(search.FirstName.Item1 ? search.FirstName.Item2 : record.FirstName, StringComparison.OrdinalIgnoreCase)
            ...
            {
                return record.FirstName.Equals(search.FirstName.Item2, StringComparison.OrdinalIgnoreCase)
