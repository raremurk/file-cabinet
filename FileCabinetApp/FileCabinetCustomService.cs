...
namespace FileCabinetApp
{
    ...
    public class FileCabinetCustomService : FileCabinetService
    {
        ...
        private const short WorkPlaceNumberMinValue = 10;
        private const decimal SalaryMinValue = 200m;
        private static readonly DateTime MinDate = new (1980, 1, 1);
        ...
        public override bool CheckString(int stringLength)
        {
        ...
        public override bool CheckDateTimeRange(DateTime argument)
        {
        ...
        public override bool CheckWorkPlaceNumber(short argument)
        {
        ...
        public override bool CheckSalary(decimal argument)
        {
        ...
        public override bool CheckDepartment(char argument)
        {
